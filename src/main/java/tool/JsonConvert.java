...
public class JsonConvert {
    private static final Logger LOGGER = Logger.getLogger(JsonConvert.class.getName());
    ...
    public static <T> T toObject(String json, Class<T> valueType) throws JsonParseException, JsonMappingException,
            IOException {
